...
export default function TaskDetailPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full space-y-8 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 border-b border-outline-variant bg-surface-bright rounded-t-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white border border-outline-variant p-8 rounded-xl shadow-sm">
              ...
              <p className="text-on-surface leading-relaxed whitespace-pre-wrap text-left">
                {task.description}
              </p>
            </section>
