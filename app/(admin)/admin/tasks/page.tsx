...
export default function TasksPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full space-y-8 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm">
      {/* Page Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 p-6 border-b border-outline-variant bg-surface-bright rounded-t-xl">
        <div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-3 bg-white border border-outline-variant rounded-lg p-2 flex items-center shadow-sm">
        ...
        <div className="space-y-4">
          {filteredTasks.length > 0 ? (
            ...
            <div className="text-center py-20 bg-surface-container-low border border-dashed border-outline-variant rounded-lg">
